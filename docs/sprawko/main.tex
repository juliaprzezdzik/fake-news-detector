...
W celu przebicia tzw. \emph{performance ceiling} 0{,}32 (sekcja
\ref{tab:liar_ceiling}) zastosowaliśmy rozszerzoną wersję datasetu --
...
\subsection{Próba 3 -- Qwen 2.5 3B Instruct (open-source LLM, zero-shot)}

Jako dodatkowy baseline porównawczy zastosowano model open-source
\texttt{Qwen/Qwen2.5-3B-Instruct} (3 mld parametrów, dekoder-only).
Inferencja przeprowadzona lokalnie na GPU T4 (Kaggle), z deterministycznym
generowaniem (\texttt{do\_sample=False}, max\_new\_tokens=8), w trybie
zero-shot z anglojęzycznym promptem.

\textbf{2kl zero-shot} (acc=0{,}564, macro-F1=0{,}559, unparsed=33, support=1234):
\begin{center}
\begin{tabular}{lrrrr}
\toprule
 & precision & recall & f1-score & support \\
\midrule
fake & 0{,}50 & 0{,}76 & 0{,}60 & 538 \\
real & 0{,}69 & 0{,}41 & 0{,}51 & 696 \\
\bottomrule
\end{tabular}
\end{center}

\textbf{6kl zero-shot} (acc=0{,}196, macro-F1=0{,}154, unparsed=45, support=1222):
\begin{center}
\begin{tabular}{lrrrr}
\toprule
 & precision & recall & f1-score & support \\
\midrule
pants-fire   & 0{,}16 & 0{,}72 & 0{,}26 &  90 \\
false        & 0{,}22 & 0{,}50 & 0{,}30 & 241 \\
barely-true  & 0{,}12 & 0{,}09 & 0{,}10 & 208 \\
half-true    & 1{,}00 & 0{,}00 & 0{,}01 & 249 \\
mostly-true  & 0{,}29 & 0{,}09 & 0{,}14 & 233 \\
true         & 0{,}37 & 0{,}07 & 0{,}11 & 201 \\
\bottomrule
\end{tabular}
\end{center}

\textit{Obserwacje:} Qwen 2.5 3B osiąga wyraźnie słabsze wyniki niż
modele OpenAI (gpt-4o-mini, gpt-4o) oraz fine-tuned RoBERTa-large --
zgodnie z oczekiwaniem dla modelu 10$\times$ mniejszego od GPT i 3$\times$
większego, ale niefinetunowanego, w porównaniu do RoBERTy. Model
ma silną tendencję do nadmiernego predykowania klas skrajnych
(\texttt{pants-fire}, \texttt{false}) oraz prawie nigdy nie wybiera klasy
\texttt{half-true} (recall=0{,}004). Qwen 3B służy więc jako dolne
ograniczenie (\emph{lower bound}) dla podejścia open-source-LLM bez
fine-tuningu, pokazując, że na zadaniu LIAR sama skala modelu i jakość
pretreningu OpenAI mają znaczenie.
...
0{,}344) wyraźnie przewyższają referencyjny benchmark z oryginalnej
publikacji.
...
Nasza RoBERTa-large 2kl (0{,}738) wyraźnie przebija barierę 0{,}62
raportowaną w literaturze, a GPT-4o 6kl (0{,}344) -- przekracza sufit
0{,}32.
