...
\begin{frame}{Tryby promptingu + darmowe LLM z OpenRouter}
  ...
  \vspace{0.3em}
  \textbf{Darmowe modele (OpenRouter)} -- wszystkie to dekoder-only Transformery,
  różnią się głównie producentem, wielkością i specjalizacją:
  \begin{center}
  \begin{tabular}{lll}
    \toprule
    ...
    \textbf{gemma-4-31b-it}         & 31B & Instrukcyjnie strojony, mocny w zadaniach tekstowych \\
    \textbf{dolphin-mistral-24b}    & 24B & ,,Uncensored'' -- bez filtrów bezpieczeństwa \\
    \textbf{llama-3.3-70b-instruct} & 70B & Największy z czwórki, flagowy open-source od Mety \\
    \bottomrule
  \end{tabular}
  \end{center}
\end{frame}
...
\begin{frame}{Wyniki -- GPT (OpenAI API) + darmowe LLM}
  ...
  \begin{tabular}{lrrrr}
    ...
    gemma-4-31b-it zero-shot$^\star$     & 0{,}442 & 0{,}306 & --- & --- \\
    gemma-4-31b-it few-shot$^\star$      & 0{,}442 & 0{,}306 & --- & --- \\
    dolphin-mistral-24b zero-shot$^\star$ & 0{,}442 & 0{,}306 & --- & --- \\
    dolphin-mistral-24b few-shot$^\star$  & 0{,}442 & 0{,}306 & --- & --- \\
    llama-3.3-70b-instruct few-shot$^\star$ & 0{,}442 & 0{,}306 & --- & --- \\
    \midrule
  ...
  \end{center}
  \vspace{0.3em}
  \scriptsize $^\star$ gemma-4-31b-it, dolphin-mistral-24b i llama-3.3-70b:
  120/120 odpowiedzi nie sparsowało się, fallback przypisał wszystko do
  \texttt{fake} -- wynik niereprezentatywny.
\end{frame}
