...
\begin{frame}{Wyniki -- fine-tuning encoderów}
  ...
  \begin{tabular}{lrrrr}
    ...
    \textbf{RoBERTa-large + Optuna}      & \textbf{0{,}738} & \textbf{0{,}728} & \textbf{0{,}357} & \textbf{0{,}359} \\
...
\begin{frame}{Wyniki -- GPT (OpenAI API) + darmowe LLM}
  ...
  \begin{tabular}{lrrrr}
    ...
    Model & 2kl Acc & 2kl Macro-F1 & 6kl Acc & 6kl Macro-F1 \\
    \midrule
    \multicolumn{5}{l}{\textbf{OpenRouter (darmowe)}} \\
...
\begin{frame}{Najlepsze wyniki z każdej kategorii}
  ...
  \begin{tabular}{llcc}
    ...
    \midrule
    Encoder       & RoBERTa-large (+ LIAR-PLUS na 6kl) & \textbf{0{,}728} & 0{,}341 \\
