...
\begin{frame}{Optuna -- automatyczne strojenie hiperparametrów}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      ...
      \textbf{Efekt:} val F1 od $0{,}681$ do $\textbf{0{,}726}$.
    ...
    \begin{column}{0.45\textwidth}
      ...
      \begin{tabular}{lrr}
        ...
        patience         & 2 & 2 \\
        \midrule
        \textbf{val F1}  & \textbf{0{,}726} & \textbf{0{,}359} \\
        \bottomrule
      \end{tabular}
    \end{column}
  \end{columns}
  ...
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      ...
      \begin{tabular}{lrrrr}
        ...
        \midrule
        fake          & 0{,}698 & 0{,}680 & 0{,}689 & 553 \\
        real          & 0{,}757 & 0{,}772 & 0{,}764 & 714 \\
        \midrule
        accuracy      &        &        & 0{,}732 & 1267 \\
        macro avg     & 0{,}727 & 0{,}726 & 0{,}726 & 1267 \\
        weighted avg  & 0{,}731 & 0{,}732 & 0{,}731 & 1267 \\
        \bottomrule
      \end{tabular}
      \end{center}
      ROC AUC: 0{,}788\quad balanced acc: 0{,}726
    \end{column}
    \begin{column}{0.45\textwidth}
      \centering
...
\begin{frame}{Wnioski}
  \begin{itemize}
    ...
    \item \textbf{Performance ceiling 6kl} ($\sim$0{,}32) przekroczyliśmy dzięki Optuna + wagi klas
  \end{itemize}
\end{frame}
